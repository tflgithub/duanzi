 ...
 */
public class TflListRecyclerView extends RecyclerView {
    ...
    public TflListRecyclerView(Context context) {
        super(context);
    }

    public TflListRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TflListRecyclerView(Context context, AttributeSet attrs, int defStyle) {
     ...
     */
    public void enableAutoLoadMore(final TflLoadMoreListener loadMoreListener) {
