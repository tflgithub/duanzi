...
public class UpdateMobileFragment$$ViewBinder<T extends com.anna.duanzi.fragment.UpdateMobileFragment> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624234, "field 'tv_bind_phone_number_error'");
    target.tv_bind_phone_number_error = finder.castView(view, 2131624234, "field 'tv_bind_phone_number_error'");
    view = finder.findRequiredView(source, 2131624233, "field 'et_bind_phone_number'");
    target.et_bind_phone_number = finder.castView(view, 2131624233, "field 'et_bind_phone_number'");
    view = finder.findRequiredView(source, 2131624206, "method 'onClick'");
