...
public class CommentActivity extends BaseActivity implements View.OnClickListener {
                ...
                query.findInBackground(new FindCallback<Comment>() {
                    ...
                    public void done(List<Comment> list, AVException e) {
                        ...
                        if (list != null && list.size() > 0) {
                            ...
                            Toast.makeText(CommentActivity.this, "暂无更新评论", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    protected void onResume() {
        if (getIntent().getExtras().getBoolean("isComment")) {
    ...
    private Handler popupHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    commentPopupWindow.showAtLocation(CommentActivity.this.findViewById(R.id.main), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
                    break;
            }
        }
    };
