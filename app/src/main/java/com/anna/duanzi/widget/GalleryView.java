...
public class GalleryView extends HorizontalScrollView  implements
    ...
    public static class HorizontalScrollViewAdapter {

        private LayoutInflater mInflater;
        private int[] resId;

        public HorizontalScrollViewAdapter(Context context, int[] resId) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            viewHolder.mImg.setImageResource(resId[position]);
            return convertView;
        }
