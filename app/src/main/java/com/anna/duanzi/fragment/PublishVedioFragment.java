...
import com.anna.duanzi.widget.BothWayProgressBar;
...
public class PublishVedioFragment extends BaseFragment implements SurfaceHolder.Callback, View.OnTouchListener, BothWayProgressBar.OnProgressEndListener {
    ...
    public View initView() {
        ...
        mDetector = new GestureDetector(getContext(), new ZoomGestureListener());
        /**
        ...
        mStartButton = view.findViewById(R.id.main_press_control);
        mTvTip = (TextView) view.findViewById(R.id.main_tv_tip);

        mStartButton.setOnTouchListener(this);
        //自定义双向进度条    (这个地方差点把我急疯了!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!)
        mProgressBar = (BothWayProgressBar) view.findViewById(R.
    ...
    private void stopRecordSave() {
        if (isRecording) {
            ...
            mMediaRecorder.stop();
            isRecording = false;
            Toast.makeText(getContext(), "视频已经放至" + mTargetFile.getAbsolutePath(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private static class MyHandler extends Handler {
        private WeakReference<PublishVedioFragment> mReference;
        private PublishVedioFragment mFragment;

        public MyHandler(PublishVedioFragment fragment) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    mFragment.mProgressBar.setProgress(mFragment.mProgress);
                    break;
            }
        }
    }
                    ...
                    case MotionEvent.ACTION_UP:
                        if (ex > left && ex < right) {
                            ...
                            if (!isCancel) {
                                ...
                                stopRecordUnSave();
                                isCancel = false;
                                Toast.makeText(getContext(), "取消录制", Toast.LENGTH_SHORT).show();
                                mProgressBar.setCancel(false);
                            }
                            ret = false;
                        }
