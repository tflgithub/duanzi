...
public class VideoEvents {
    ...
    public static final int VE_SURFACEHOLDER_FINISH_VIDDEOACTIVITY = 366012;
    public static final int VE_IS_LOGIN = 00000;
    public static final int VE_IS_VIP = 000001;
    // 埋点事件
    // Buried point events
    /**
     * <p>用户点击播放按钮,播放视频</p>
